...
public class BattleTest {
    ...
    public void testAddElementalDamageWithDifferentElement_expectChangedDamage(){
        ...
        User user2 = prepUser();
        Battle testBattle = new Battle(user1, user2);
        Card card1 = new Card("WaterMagicSpell", 20, 1);
        Card card2 = new Card("FireWizardMonster", 20, 2);
    ...
    public void testAddElementalDamageWithSameElement_expectUnChangedDamage(){
        ...
        Battle testBattle = new Battle(user1, user2);
        Card card1 = new Card("WaterMagicSpell", 20, 1);
        Card card2 = new Card("WaterWizardMonster", 10, 2);
    ...
    public void testAddMonsterSpecialities_expectDamageTo0(){
        ...
        User user2 = prepUser();
        Battle testBattle = new Battle(user1, user2);
        Card card1 = new Card("WaterGoblinMonster", 20, 1);
        Card card2 = new Card("WaterDragonMonster", 10, 2);
    ...
    public void testWhichCardStronger_expectCard1(){
        ...
        Battle testBattle = new Battle(user1, user2);
        Card card1 = new Card("WaterMagicSpell", 20, 1);
        Card card2 = new Card("FireDragonMonster", 20, 2);
    ...
    public void testWhichCardStronger_expectDraw(){
        ...
        User user2 = prepUser();
        Battle testBattle = new Battle(user1, user2);
        Card card1 = new Card("WaterMagicSpell", 10, 1);
        Card card2 = new Card("FireDragonMonster", 40, 2);
