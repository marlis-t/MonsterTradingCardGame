...
public class StackOfCardsTest {
    ...
    public void testAddingCardsToList_expectNoException(){
        StackOfCards stack = new StackOfCards();
        Card testCard1 = new Card("NormalSpell", 0,1);
        Card testCard2 = new Card("NormalSpell", 0, 2);
    ...
    public void testGettingBest4CardsOfSmallStack_expect2(){
        StackOfCards stack = new StackOfCards();
        Card card1 = new Card("NormalSpell", 20, 1);
        Card card2 = new Card("NormalSpell", 25, 2);
        Card card3 = new Card("NormalSpell", 30, 3);
        stack.addCard(card1);
        stack.addCard(card2);
        stack.addCard(card3);
